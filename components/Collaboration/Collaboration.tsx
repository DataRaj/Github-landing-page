			...
			<div className="flex md:pl-7 space-x-3 md:space-x-10">
				...
				<motion.div
					...
					<h3
						...
						<span className="text-[#33b3ae]">Supercharge collaboration</span>
						<br />
				...
				<div className="relative w-[50%] lg:block hidden">
					<Image
						...
						width={502}
						height={735}
						className="absolute top-[9%] right-[-15%] -z-10"
					/>
				</div>
			</div>
			<Image
							...
							<motion.div
								...
								<Link
									...
									<Image
										...
										src={item.src}
									/>
									<div className="text-[#7d8590] my-2">{item.title}</div>
									<button
										type="button"
				...
				<div className="py-3 mb-2 flex flex-col w-full gap-y-5">
					<div className="py-10">
						...
						<p className="mb-4 md:text-xl text-[16px] text-[#7d8590]">
							...
							GitHub is your home. <br /> Join the world’s largest developer
					...
					<div className="flex lg:w-11/12 max-md:flex-col">
						...
						<span className="border-t md:border-l border-neutral-700 md:mx-5 mb-3 md:mb-0" />
						<Link
							onMouseEnter={() => setHovered1(true)}
							onMouseLeave={() => setHovered1(false)}
							href=""
